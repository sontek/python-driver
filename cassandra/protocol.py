...
try:
    from ccassandra import native_row_parser
    def default_row_parser(row_count, column_metadata, f, protocol_version,
                           col_types):
        return native_row_parser(row_count, column_metadata, f.read(),
                                 protocol_version, col_types)
except ImportError:
